...
$shuffle.textContent = "섞기";
// $sort.textContent = 'Sort'
// $bysuit.textContent = "By suit";
// $fan.textContent = "Fan";
// $poker.textContent = "Poker";
$flip.textContent = "뒤집기";
...
deck.cards.forEach(function (card, i) {
  ...
  //     acesClicked[i] = true;
  //     if (
  //       acesClicked.filter(function (ace) {
  //         return ace;
  //       }).length === 4
  //     ) {
  ...
  //     kingsClicked[i] = true;
  //     if (
  //       kingsClicked.filter(function (king) {
  //         return king;
  //       }).length === 4
  //     ) {
  //       for (var j = 0; j < 3; j++) {
...
function startWinning() {
  ...
  $winningDeck.style[transform] = translate(
    Math.random() * window.innerWidth - window.innerWidth / 2 + "px",
    Math.random() * window.innerHeight - window.innerHeight / 2 + "px"
  );
