...
var Deck = (function () {
  ...
  var question = [
    ...
    "발 사이즈가 어떻게 되세요?",
    "살아오면서 한 가장 나쁜 짓이 무엇인가요?",
    "평소에 개발하실때 어떤 키보드를 사용하시나요? 아니면 사용하고 싶은 키보드에 대해 답변해주셔도 좋습니다.",
    "광진님 과거에 한국말 못알아듣는척 해보신적 있으신가요?ㅎ",
    "'나는 이거 못먹는다' 하는 음식 있나요? ",
    "다녀본 국내 여행지중 가장 특별한곳은 어디인가요?",
    "플랫폼 분들중 더 알고싶은 한명을 뽑자면 누구? 왜? ",
    "돈과 시간이 있다면 새로하고 싶은 취미는 어떤게 있나요? ",
    "가장 남들이 해보지 않았을 것 같은 특이한 경험이 있으신가요?",
    "가장 빠르게 달려본 적은 언제인가요?",
    "올해가 가기 전에 꼭 이루고 싶은 것은?",
    "내가 다시 태어난다면 하고 싶은 직업은?",
    "내가 제일 좋아하는 계절은?",
    "제일 좋아하는 영화",
    "초등학교 시절 가장 잘 했던 과목 ",
    "눈사람을 냉장고에 넣어본 적이 있나요?",
    "노래방에 가면 마이크를 독점하는 스타일인가요?",
    "우울할때는 뭘 하면서 시간을 보내세요?",
    "회사에 처음 들어오고 든 생각은?",
    "개발자가 안됬으면 뭘 하고 있었을지",
    "제일 좋아하는 색깔은?",
    "처음 사게된 핸드폰 브랜드와 기종은?",
    ...
    "부먹 vs 찍먹",
    "가장 좋아하는 음식은 뭔가요?",
    "현재 핸드폰 배경화면은 무엇인가요? 왜 고른건가요?",
    "그동안 받은 조언 중 최악의 조언은 무엇인가요?",
    "강아지 vs 고양이",
    "사소하고 쓸데없는 재능같은게 있나요? 밥알 인형 만들기 같은",
    "제일 잘하는 게임이 무엇인가요? 디지털, 피지컬 노 상관",
    "다른 나라에서 살아야 한다면 어느 나라를 고르시겠어요?",
    "성민님이 보기에 백엔드 플랫폼의 오과장과 김대리는 누구일까요",
  ];
  ...
  function Deck(jokers) {
    ...
    var cards = new Array(question.length);
